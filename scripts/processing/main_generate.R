...
input_files <- list(
  tmean = paste0("../../preprocessing/ERA5_land_data/data/tmean_", start_year, "_", end_year, ".nc"),
  tmin = paste0("../../preprocessing/ERA5_land_data/data/tmin_", start_year, "_", end_year, ".nc"),
  rh = paste0("../../preprocessing/ERA5_land_data/data/rh_", start_year, "_", end_year, ".nc"),
  rs = paste0("../../preprocessing/ERA5_land_data/data/solar_radiation_", start_year, "_", end_year, ".nc"),
  prec = paste0("../../preprocessing/ERA5_land_data/data/precipitation_", start_year, "_", end_year, ".nc"),
...
lat_blocks <- seq(start_block, length(lats), by = block_size)
...
for (block_start in lat_blocks) {
  ...
  variables <- list(
    ...
    prec = ncvar_get(nc_data$prec, "tp", start = c(1, lat_indices[1], 1), count = c(length(lons), length(lat_indices), -1)) * 1000 * 30, # https://confluence.ecmwf.int/pages/viewpage.action?pageId=197702790
